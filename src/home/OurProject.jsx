  ...
  return (
    <div className='px-4 lg:px-24 my-20 flex felx-col md:flex-row justify-between items-center gap-12'>
            ...
            <div className='md:w-1/2 space-y-6'>
                ...
                <p className='mb-10 text-lg md:w-5/6'>"Explore excellence through our curated premium projects.
                Discover our top-tier projects, showcasing exceptional craftsmanship and innovative design."</p>
