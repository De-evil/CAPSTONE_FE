...
const EditWork = () => {
  ...
  const WorkCategories = [
   ...
   const handleUpdate = (event) => {
    ...
    //  console.log(WorkObj);
    // update the data
    fetch(`https://capstone-be-1-de7q.onrender.com/work/${id}`, {
      method: "PATCH",
      headers: {
    ...
    return (
      <div className='px-4 my-12'>
        ...
        <div className='lg:w-1/2'>
          ...
          <TextInput id="Name" name='Name' placeholder="Name" required defaultValue={Name} />
        </div>
        <div className='lg:w-1/2'>
          <div className="mb-2 block">
            <Label htmlFor="location" value="location" />
          </div>
          <TextInput id="location" name='location'  placeholder="Eg: Coimbatore, Tamil Nadu" required defaultValue={location} />
        </div>
        </div>
        {/* second row */}
        <div className='flex gsp-8'>
        ...
        <div className='lg:w-1/2'>
          ...
          <TextInput id="imageURL" imageURL='Name'  placeholder="Image URL" required  defaultValue={imageURL} />
        </div>
        <div className='lg:w-1/2'>
        <div className="mb-2 block">
