...
const ManageWork = () => {
  ...
  const [allWorks, setAllWorks] = useState([]);
   useEffect(() => {
     fetch("https://capstone-be-1-de7q.onrender.com/all-works").then(res => res.json()).then(data => setAllWorks(data));
   },[])
  ...
  return (
    <div className='px-4 my-12'> 
       <h2 className='mb-8 text-3xl font-bold'>Managing Works</h2>
