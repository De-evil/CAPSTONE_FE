...
const UploadWork = () => {
 ...
 const handleWorkSubmit = (event) => {
  ...
  fetch('https://capstone-be-1-de7q.onrender.com/upload-work', { 
    method: "POST",
    headers: {
  ...
  return (
    <div className='px-4 my-12'>
      ...
      <div className='lg:w-1/2'>
        ...
        <TextInput id="Name" name='Name' placeholder="Name" required type='text' />
      </div>
      <div className='lg:w-1/2'>
        <div className="mb-2 block">
          <Label htmlFor="location" value="location" />
        </div>
        <TextInput id="location" name='location'  placeholder="Eg: Coimbatore, Tamil Nadu" required type='text' />
      </div>
      </div>
      {/* second row */}
      <div className='flex gsp-8'>
